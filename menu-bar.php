        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="about.php">About me</a></li>
                    <li class="nav-item"><a class="nav-link link text-white display-4" href="PaulEzeani.pdf">Resume</a></li>
                    <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="index.php#contacts4-5">Contact me</a>
                    </li>
                </ul>
