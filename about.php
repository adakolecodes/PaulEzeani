...
<body>
    ...
    <section data-bs-version="5.1" class="features15 cid-ty8I1lFv52" id="features16-a">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-lg">
                        <div class="text-wrapper">
                            ...
                            <p class="mbr-text mbr-fonts-style mb-4 display-4">Visual designer and art enthusiast, Paul is a creative mastermind and co-founder of MASPEC™. With a keen eye for detail and a unique blend of technical expertise and artistic vision, Paul brings a fresh perspective to the world of design. <br><br>At MASPEC™, he is dedicated to elevating the art of visual storytelling and helping businesses connect with their audience through compelling design.<br><br>Paul is a visionary who is changing the world, one brush stroke at a time.<br></p>

                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                        <div class="image-wrapper">
                            <img src="assets/images/download-1-1000x999.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section data-bs-version="5.1" class="footer3 cid-ty8xbZ73Ml" once="footers" id="footer3-8">
